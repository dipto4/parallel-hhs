...
int main() {
    std::cout<<"TEST: size and condition for the splitting routine [single block] NSIZE : 512, BLOCKSIZE : 256, UNROLL: 2"<<std::endl;
    test_split_single_block<512, 256, 2>();

    
    std::cout<<"TEST: size and condition for the splitting routine [single block] NSIZE : 4090, BLOCKSIZE : 1024, UNROLL: 4"<<std::endl;
    test_split_single_block<4090, 1024, 4>();

    std::cout<<"TEST: size and condition for the splitting routine [multi block] NSIZE : 2048 BLOCKSIZE : 512, UNROLL: 2"<<std::endl;
    test_split_multi_block<2048,512, 2>();

    std::cout<<"TEST: size and condition for the splitting routine [multi block] NSIZE : 2151 BLOCKSIZE : 512, UNROLL: 2"<<std::endl;
    test_split_multi_block<2151,512, 2>();

    std::cout<<"TEST: size and condition for the splitting routine [multi block] NSIZE : 524288 BLOCKSIZE : 128, UNROLL: 4"<<std::endl;
    test_split_multi_block<524288, 128, 4>();

    std::cout<<"TEST: size and condition for the splitting routine [multi block] NSIZE : 588021 BLOCKSIZE : 128, UNROLL: 4"<<std::endl;
    test_split_multi_block<588021,128,4>();

    std::cout<<"TEST: size and condition for the splitting routine [multi block] NSIZE : 1048576 BLOCKSIZE : 128, UNROLL: 4"<<std::endl;
    test_split_multi_block<1048576,128, 4>();

    std::cout<<"TEST: size and condition for the splitting routine [multi block] NSIZE : 2097152 BLOCKSIZE : 128, UNROLL: 4"<<std::endl;
    test_split_multi_block<2097152,128,4>();
